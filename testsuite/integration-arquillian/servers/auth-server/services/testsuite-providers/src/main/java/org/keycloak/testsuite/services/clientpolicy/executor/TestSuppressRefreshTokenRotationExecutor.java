 ...
 */
public class TestSuppressRefreshTokenRotationExecutor implements ClientPolicyExecutorProvider<ClientPolicyExecutorConfigurationRepresentation> {

    private static final Logger logger = Logger.getLogger(TestSuppressRefreshTokenRotationExecutor.class);

    protected final KeycloakSession session;

    public TestSuppressRefreshTokenRotationExecutor(KeycloakSession session) {
        this.session = session;
    }

    @Override
    public String getProviderId() {
        return TestSuppressRefreshTokenRotationExecutorFactory.PROVIDER_ID;
    }
